...
\texttt{cd bachelor/labs/\_stack \&\& docker compose pull \&\& docker compose up -d \&\& docker compose ps}.
Confirm \texttt{openplc}, \texttt{opcua}, \texttt{mqtt}, \texttt{zeek}, \texttt{student} all show \texttt{Up}.
Each lecturer machine needs: Docker $\geq$ 24, $\sim$3 GB free for images, host port 8080 (OpenPLC UI) and 1880 (Node-RED) free, and projector-readable terminal font ($\geq$ 18 pt).
}
