...
\texttt{bachelor/labs/preflight.sh -{}-pull -{}-bootstrap}.
All 16 checks must pass: services up, landing page at \url{http://127.0.0.1:8000}, OpenPLC primed with \texttt{conveyor.st}, Modbus 502 open, OPC UA 4840 open, Zeek raises the \texttt{ModbusWatch::Unsolicited\_Write} notice on injection.
