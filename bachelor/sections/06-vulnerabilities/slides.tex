...
\begin{frame}{Anatomy of a CISA ICS Advisory --- ICSA-23-103-10}
\centering
\begin{tikzpicture}[node distance=1.5mm, scale=0.85, transform shape]
  \node[isbox, fill=slidePanel, draw=isOT, minimum width=120mm, align=left, font=\scriptsize] (a)
    {\textbf{ICSA-ID:} ICSA-23-103-10 \quad\textbar\quad \textbf{Published:} 13 Apr 2023 \quad\textbar\quad \textbf{Vendor:} Siemens};
  \node[isbox, fill=slidePanel, draw=isOT, minimum width=120mm, align=left, font=\scriptsize, below=of a] (b)
    {\textbf{Affected:} SIMATIC CP 1242-7, CP 1243-1/-7/-8 (firmware $<$ V3.4.36)};
  \node[isbox, fill=slidePanel, draw=isOT, minimum width=120mm, align=left, font=\scriptsize, below=of b] (c)
    {\textbf{CVEs:} CVE-2022-46140 (hard-coded credential, CWE-798)};
  \node[isbox, fill=slidePanel, draw=isOT, minimum width=120mm, align=left, font=\scriptsize, below=of c] (d)
    {\textbf{CVSS v3.1:} 7.5 \ \texttt{AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N} (network, no auth, confid.\ only)};
  \node[isbox, fill=slidePanel, draw=isOT, minimum width=120mm, align=left, font=\scriptsize, below=of d] (e)
    {\textbf{Impact:} Remote attacker can extract sensitive configuration data over the network};
  \node[isbox, fill=slidePanel, draw=isOT, minimum width=120mm, align=left, font=\scriptsize, below=of e] (f)
    {\textbf{Mitigation:} Upgrade firmware to V3.4.36; restrict network access to port 102 (S7)};
  \node[isbox, fill=isAttack!15, draw=isAttack, minimum width=120mm, align=left, font=\scriptsize, below=of f] (g)
    {\textbf{Cross-ref:} Siemens SSA-479249 --- vendor PSIRT, same content, often first};
\end{tikzpicture}
\source{CISA, \emph{ICSA-23-103-10 Siemens SIMATIC CP}, 13 Apr 2023 \textbar{} Siemens SSA-479249, 2023.}
\note{
