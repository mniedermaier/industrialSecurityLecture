...
\begin{tikzpicture}[node distance=10mm]
  ...
  \draw[-{Stealth[length=2mm]}, thick] (c1) -- node[left=2pt, font=\tiny, fill=white, inner sep=1pt]{TLS} (srv);
  \draw[-{Stealth[length=2mm]}, thick] (c2) -- node[right=2pt, font=\tiny, fill=white, inner sep=1pt]{TLS} (srv);
\end{tikzpicture}
