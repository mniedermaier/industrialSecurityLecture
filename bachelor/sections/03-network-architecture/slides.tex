...
\end{tikzpicture}
\par\vspace{1mm}
{\footnotesize Zones group assets with similar security needs; conduits are the controlled channels between them. \textbf{SL-T 1--4} = target resistance, from casual mis-use up to a sophisticated, well-resourced attacker (IEC 62443-3-3 \S\,5).}
\note{
