...
\begin{tikzpicture}[node distance=8mm, scale=0.8, transform shape]
  ...
  \draw[conduit] (h2.east) to[bend left=22] node[pos=0.5, yshift=4mm, font=\tiny, fill=white, inner sep=2pt] {OPC UA} (p1.west);
  \draw[conduit] (h1.east) to[bend left=45] (p2.west);
  \draw[conduit] (p1.south) -- node[pos=0.5, xshift=8mm, font=\tiny, fill=white, inner sep=2pt] {dry contact} (s1.north);
...
\begin{tikzpicture}[node distance=4mm, scale=0.82, transform shape, font=\scriptsize]
  \begin{scope}[shift={(0,0)}]
    ...
    \node[font=\tiny, below=26mm of m1, align=center] {1 mgr blocks 1 port\\recover $\le$200\,ms};
  \end{scope}
  \begin{scope}[shift={(4.5,0)}]
    ...
    \node[font=\tiny, below=26mm of h1, align=center] {send both ways\\zero-loss};
  \end{scope}
