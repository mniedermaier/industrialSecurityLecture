...
\scriptsize
\begin{tabular}{|p{20mm}|p{18mm}|p{16mm}|p{20mm}|p{38mm}|}
\hline
\rowcolor{slidePanel}
...
\hline
EtherNet/IP  & soft (CIP)         & L1--L4 std        & Rockwell / ODVA    & CIP objects over UDP/TCP \\
\hline
PROFINET RT  & hard (1\,ms)       & L1--L2 std, custom L3 & Siemens (PNO)  & VLAN-tagged Ethernet frames, no IP \\
\hline
...
Modbus TCP $\approx$ HTTP on a LAN: works on any switch. EtherCAT $\approx$ InfiniBand: needs special silicon and dedicated wiring. The harder the real-time guarantee, the less of the standard IP stack survives.
\end{notebox}
\source{IEC 61784-2:2023, \emph{Industrial communication networks --- Profiles --- Part 2: Additional fieldbus profiles for real-time networks} \textbar{} ODVA, \emph{The CIP Networks Library}, Vol.\,2, 2024.}
\note{
