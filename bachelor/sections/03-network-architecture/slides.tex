...
A misconfigured trunk port (DTP enabled, native VLAN guessed) lets an attacker hop. Use VLANs for organisation; require a routed firewall for security boundaries.
\end{warnbox}
\end{frame}
