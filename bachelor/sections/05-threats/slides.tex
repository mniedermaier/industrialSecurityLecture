...
\begin{tikzpicture}[node distance=12mm]
  ...
  \draw[attack] (atk) -- node[right=3pt, font=\tiny, align=center, fill=white, inner sep=2pt]{TriStation\\proprietary} (sis);
\end{tikzpicture}
\par\vspace{1mm}
...
\end{warnbox}
\source{CISA \mbox{\emph{AA24-038A}}, ``PRC State-Sponsored Actors Compromise and Maintain Persistent Access to U.S.\ Critical Infrastructure'', 7 Feb 2024 \textbar{} Microsoft, \emph{Volt Typhoon}, May 2023.}
\end{frame}
