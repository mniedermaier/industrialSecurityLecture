...
\begin{tikzpicture}[x=2.6cm, y=1.2cm]
  \node[isbox, fill=isAttack!15, draw=isAttack, font=\tiny, text width=33mm, minimum height=14mm, align=center, inner sep=2pt] at (0,0) {Spearphish\\corporate IT};
  \node[isbox, fill=isAttack!15, draw=isAttack, font=\tiny, text width=33mm, minimum height=14mm, align=center, inner sep=2pt] at (1,0) {Compromised\\vendor};
  \node[isbox, fill=isAttack!15, draw=isAttack, font=\tiny, text width=33mm, minimum height=14mm, align=center, inner sep=2pt] at (2,0) {Internet-exposed\\PLC / HMI};
  \node[isbox, fill=isAttack!15, draw=isAttack, font=\tiny, text width=33mm, minimum height=14mm, align=center, inner sep=2pt] at (3,0) {USB / removable\\media};
  \node[isbox, fill=isAttack!15, draw=isAttack, font=\tiny, text width=33mm, minimum height=14mm, align=center, inner sep=2pt] at (0,-1.6) {Stolen / shared\\credentials};
  \node[isbox, fill=isAttack!15, draw=isAttack, font=\tiny, text width=33mm, minimum height=14mm, align=center, inner sep=2pt] at (1,-1.6) {Vendor remote\\access};
  \node[isbox, fill=isAttack!15, draw=isAttack, font=\tiny, text width=33mm, minimum height=14mm, align=center, inner sep=2pt] at (2,-1.6) {VPN with\\no MFA};
  \node[isbox, fill=isAttack!15, draw=isAttack, font=\tiny, text width=33mm, minimum height=14mm, align=center, inner sep=2pt] at (3,-1.6) {Insider with\\physical access};
\end{tikzpicture}
\end{frame}
