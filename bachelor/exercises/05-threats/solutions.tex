...
\bottomrule
\end{tabular}\\[2pt]
The 2015~$\to$~2016 transition shows the adversary moving from hands-on-keyboard abuse of
legitimate tools to automated, protocol-native tooling -- a step change in capability and a
template for Industroyer2 (2022). \emph{Sources:} SANS/E-ISAC 2016; ICS-CERT IR-ALERT-H-16-056-01; ESET 2017; Dragos \emph{CRASHOVERRIDE} 2017.
\end{solutionbox}
