...
% Last-resort inter-word stretch before TeX reports an Overfull \hbox.
% Only engages on lines that would otherwise overflow (long \texttt
% tokens, hex, URLs); never loosens a line that already fits.
