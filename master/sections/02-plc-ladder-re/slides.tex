...
\footnotesize
\begin{tabular}{|p{3.2cm}|p{3.4cm}|p{3.4cm}|p{3.6cm}|}
\hline
\rowcolor{slidePanel}
...
\begin{tikzpicture}[x=1.7cm, y=1cm]
  \node[isbox, fill=isOT!15, draw=isOT, minimum width=22mm, font=\scriptsize, align=center] at (0,0) {Input image\\(I)};
  \node[isbox, fill=isPLC!15, draw=isPLC, minimum width=22mm, font=\scriptsize, align=center] at (1.6,0) {Output image\\(Q)};
  \node[isbox, fill=isAccent!15, draw=isAccent, minimum width=22mm, font=\scriptsize, align=center] at (3.2,0) {Markers\\(M)};
  \node[isbox, fill=isHMI!15, draw=isHMI, minimum width=22mm, font=\scriptsize, align=center] at (4.8,0) {Timers\\(T)};
  \node[isbox, fill=isMute!15, draw=isMute, minimum width=22mm, font=\scriptsize, align=center] at (6.4,0) {Counters\\(C)};
  \node[isbox, fill=isAttack!15, draw=isAttack, minimum width=22mm, font=\scriptsize, align=center] at (8,0) {Data\\blocks (DB)};
\end{tikzpicture}
\vspace{2mm}
